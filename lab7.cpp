...
void init_G(double Gm[][N], double Gc[N], double Gx[N], double Gxn[N]) {

}

void init_S(double Sm[][N], double Sc[N], double Sx[N], double Sxn[N]) {

}

int main() {
    double Jm[N][N], Gm[N][N], Sm[N][N];
    double Jc[N], Gc[N], Sc[N];
    double Jx[N], Gx[N], Sx[N];
